...
export default function AttendanceCalendar({setMonthlyPresent}) {
  ...
  function addAttendanceTiles(){
    try{
    // select dates the student was present on
    ...
    // set the total monthly attendance of the student
    setMonthlyPresent(data.days.length)
